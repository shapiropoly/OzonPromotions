...
async def main():
    ...
    async with create_session() as session:
        ...
        # p1 = Product(product_id=123, name="p1", price=100, action_price=50, action_id=111)
        # p2 = Product(product_id=234, name="p2", price=100, action_price=50, action_id=111)
        # p3 = Product(product_id=345, name="p3", price=100, action_price=50, action_id=111)
        # #
        # p1.companies = [c1]
        # p2.companies = [c1]
        # p3.companies = [c1]
